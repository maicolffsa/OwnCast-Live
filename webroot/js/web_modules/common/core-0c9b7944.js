...
var TEXTAREA_ELEMENT = document_1$1.createElement("textarea");
...
window_1$1.vttjs = vttjs;
window_1$1.WebVTT = vttjs.WebVTT;

var cueShim = vttjs.VTTCue;
var regionShim = vttjs.VTTRegion;
var nativeVTTCue = window_1$1.VTTCue;
var nativeVTTRegion = window_1$1.VTTRegion;

vttjs.shim = function() {
  window_1$1.VTTCue = cueShim;
  window_1$1.VTTRegion = regionShim;
};

vttjs.restore = function() {
  window_1$1.VTTCue = nativeVTTCue;
  window_1$1.VTTRegion = nativeVTTRegion;
};

if (!window_1$1.VTTCue) {
  vttjs.shim();
}
});
...
var document$1 = _interopDefault(document_1);
...
var safeParseTuple = _interopDefault(tuple);
var keycode = _interopDefault(keycode$1);
var XHR = _interopDefault(xhr);
var vtt = _interopDefault(browserIndex);
...
var TimeDisplay = /*#__PURE__*/function (_Component) {
  ...
  _proto.updateTextNode_ = function updateTextNode_(time) {
    ...
    this.requestNamedAnimationFrame('TimeDisplay#updateTextNode_', function () {
      ...
      _this2.textNode_ = document$1.createTextNode(_this2.formattedTime_);
...
var LoadProgressBar = /*#__PURE__*/function (_Component) {
  ...
  _proto.createEl = function createEl$1() {
    ...
    var separator = document$1.createTextNode(': ');
...
var VolumePanel = /*#__PURE__*/function (_Component) {
  ...
  _proto.handleMouseOver = function handleMouseOver(event) {
    ...
    on(document$1, 'keyup', bind(this, this.handleKeyPress));
  }
  /**
  ...
  _proto.handleMouseOut = function handleMouseOut(event) {
    ...
    off(document$1, 'keyup', bind(this, this.handleKeyPress));
  }
  /**
...
var Menu = /*#__PURE__*/function (_Component) {
  ...
  _proto.handleBlur = function handleBlur(event) {
    var relatedTarget = event.relatedTarget || document$1.activeElement; // Close menu popup when a user clicks outside the menu
...
var MenuButton = /*#__PURE__*/function (_Component) {
  ...
  function MenuButton(player, options) {
    ...
    _this.on(_this.menuButton_, 'mouseenter', function () {
      ...
      on(document$1, 'keyup', bind(_assertThisInitialized(_this), _this.handleMenuKeyUp));
    });
  ...
  _proto.handleMouseLeave = function handleMouseLeave(event) {
    this.removeClass('vjs-hover');
    off(document$1, 'keyup', bind(this, this.handleMenuKeyUp));
  }
  /**
...
if ('exitPictureInPicture' in document$1) {
...
var LiveTracker = /*#__PURE__*/function (_Component) {
  ...
  function LiveTracker(player, options) {
    ...
    if (IE_VERSION && 'hidden' in document$1 && 'visibilityState' in document$1) {
      _this.on(document$1, 'visibilitychange', _this.handleVisibilityChange);
    }
  ...
  _proto.dispose = function dispose() {
    this.off(document$1, 'visibilitychange', this.handleVisibilityChange);
    this.stopTracking();
...
var innerHTMLDescriptorPolyfill = Object.defineProperty({}, 'innerHTML', {
  ...
  set: function set(v) {
    ...
    var dummy = document$1.createElement(this.nodeName.toLowerCase()); // set innerHTML to the value provided

    dummy.innerHTML = v; // make a document fragment to hold the nodes from dummy

    var docFrag = document$1.createDocumentFragment(); // copy all of the nodes created by the innerHTML on dummy
  ...
  _proto.createEl = function createEl() {
    ...
    if (!el || !(this.options_.playerElIngest || this.movingMediaElementInDOM)) {
      ...
      if (el) {
        ...
        el = document$1.createElement('video'); // determine if native controls should be used
...
defineLazyProperty(Html5, 'TEST_VID', function () {
  ...
  var track = document$1.createElement('track');
  track.kind = 'captions';
  track.srclang = 'en';
  track.label = 'English';
...
var Player = /*#__PURE__*/function (_Component) {
  ...
  _proto.documentFullscreenChange_ = function documentFullscreenChange_(e) {
    ...
    var el = this.el();
    var isFs = document$1[this.fsApi_.fullscreenElement] === el;
  ...
  _proto.exitFullscreenHelper_ = function exitFullscreenHelper_() {
    ...
    if (this.fsApi_.requestFullscreen) {
      var promise = document$1[this.fsApi_.exitFullscreen]();
  ...
  _proto.enterFullWindow = function enterFullWindow() {
    ...
    this.docOrigOverflow = document$1.documentElement.style.overflow; // Add listener for esc key to exit fullscreen

    on(document$1, 'keydown', this.boundFullWindowOnEscKey_); // Hide any scroll bars

    document$1.documentElement.style.overflow = 'hidden'; // Apply fullscreen styles
  ...
  _proto.exitFullWindow = function exitFullWindow() {
    ...
    off(document$1, 'keydown', this.boundFullWindowOnEscKey_); // Unhide scroll bars.

    document$1.documentElement.style.overflow = this.docOrigOverflow; // Remove fullscreen styles

    removeClass(document$1.body, 'vjs-full-window'); // Resize the box, controller, and poster to original sizes
    // this.positionAll();
  ...
  _proto.flexNotSupported_ = function flexNotSupported_() {
    var elem = document$1.createElement('i'); // Note: We don't actually use flexBasis (or flexOrder), but it's one of the more
...
export { core as c, document_1$1 as d, window_1$1 as w };
